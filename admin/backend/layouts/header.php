...
<head>
    ...
    <link rel="icon" href="<?=base_url('public/icons/logo.png')?>">
    ...
    <link href="<?=base_url('public/admin/ckeditor/contents.css')?>" rel="stylesheet">
    <link href="<?=base_url('public/admin/build/css/custom.min.css')?>" rel="stylesheet">
    <link href="<?=base_url('public/admin/custom/custom.css')?>" rel="stylesheet">
