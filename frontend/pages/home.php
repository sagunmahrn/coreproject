<?php
$selQuery="SELECT * FROM tbl_sliders WHERE status=1";
$sliderResult=mysqli_query($connection,$selQuery);
?>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="slick_slider">
                    ...
                    <div class="single_iteam"> <a href="#"> <img src="<?=base_url('public/images/slider/'.$slider['image'])?>" alt=""></a>
                        ...
                        <div class="slider_article">
                            ...
                            <p>
                              <?=strip_tags(substr($slider['description'],0,200))?>
                            </p>
                        </div>
                    </div>
                    <?php endforeach;?>
